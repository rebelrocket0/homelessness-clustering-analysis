...
Unsupervised learning project comparing clustering algorithms on homelessness service usage data.
Project Overview
...
KMeans — Creates a fixed number of clusters and works well for identifying balanced groupings
DBSCAN — Identifies clusters based on data density and detects outliers
BIRCH — Efficient for large datasets and creates hierarchical clusters
Key Findings
